...
class UIController {
    ...
    static updateTaskDetails(e) {
        ...
        _appController__WEBPACK_IMPORTED_MODULE_0__["default"].changePriorityOfOverdueTasks(
            projectDetails.type,
            projectDetails.index
        );
    ...
    static showProjectDetails(e) {
        ...
        _appController__WEBPACK_IMPORTED_MODULE_0__["default"].changePriorityOfOverdueTasks(projectType, projectIndex);
...
class appController {
    ...
    static changePriorityOfOverdueTasks(projectType, projectIndex) {
        ...
        for (let i = 0; i < projectTasks.length; i++) {
            ...
            if (
                (0,date_fns_differenceInCalendarDays__WEBPACK_IMPORTED_MODULE_3__["default"])(
                    new Date(),
...
class BasicTask extends _BasicClassPattern__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    getDueDate() {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(this.dueDate), 'dd/MM/yyyy');
    }
